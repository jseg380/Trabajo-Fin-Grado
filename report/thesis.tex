...
\usepackage[spanish, es-tabla]{babel}   % TODO: ""Adjust"" Selecciona el español para palabras introducidas automáticamente, p.ej. "septiembre" en la fecha y especifica que se use la palabra Tabla en vez de Cuadro
